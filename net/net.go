...
/** receiveSnapshotMessage()
Réception d'un message demandant d'effectuer un Snapshot
**/
func (n *Net) receiveSnapshotMessage(msg Message) {
	...
	// Si le message est rouge et que le site est blanc
	// Envoyer l'état sur l'anneau
	...
	// Si le message est blanc et le site rouge, il s'agit d'un message prépost. Le type de message est changé et il est transmis sur l'anneau
